...
echo('<style>td{border:dotted 1px #5555AA;background-color:#FFFFFF;}th{border:solid 1px #5555AA;background-color:DDDDFF;}</style>');

$zutabe = $emaitza -> field_count;

echo('<table style = "border:solid 1px #5555AA;background-color:#DDDDFF;"><tr>');
