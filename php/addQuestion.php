...
//sql kontsulta sortu
$sql="insert into questions(mail,galdera,erantzun_zuzena,erantzun_okerra_1,erantzun_okerra_2,erantzun_okerra_3,zailtasuna,gaia,marrazkia,mota) values('".$mail."','".$galdera."','".$zuzena."','".$erantzunokerra1."','".$erantzunokerra2."','".$erantzunokerra3."',".$zailtasuna.",'".$gaia."','.null.','-')";
...
header("location:mezua.php?goiburu=Eskaera gauzatu da&gorputza=Bidalitako datuak batu-basean ongi gorde dira&auk=<a href='../layout.html'>Orri nagusia</a><br/><hr width='150px'/><br/><a href='showQuestions.php'>Ikusi galdera guztiak (marrazkirik gabe)</a>");
?>